...
const HotelItem = ({ hotel }) => {
  ...
  const { old, current, info, summary, totalPricePerStay } = handleNullObj(price) // old 라는 key가 없음
    ...
    <div className="HotelItem-container">
      ...
      <div className="HotelItem-info">
        ...
        <div className="HotelItem-rating">
          <div className={`HotelItem-rating-badge ${parseInt(rating) < 8 ? 'HotelItem-rating-badge-gray' : '' }`}>
            {rating}
          </div>
